      		...
      		<div id="foo" style="height: 400px;"> 
        	 	<table>
					<tr>
						...
						<td class="ftkeydatatdinput">
							<input id="DESCRIPTION" name="DESCRIPTION" type="text" size="20"  readonly="readonly" />
						</td>
					</tr>
					<tr>
						<td class="ftkeydatatdlabel">字段标识:</td>
						<td class="ftkeydatatdinput">
							<input id="DATA_TAG" name="DATA_TAG" type="text" size="20"  readonly="readonly" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="ftkeydatatdinput">
							<input id="PT_MASK_GROUP_BO" name="PT_MASK_GROUP_BO" type="text" size="20"  readonly="readonly" />
						</td>
					</tr>
					<tr>
